...
export const teamMembers = [
  ...
  },
  {
    ...
    description:
      'Desarrollador Back End apasionado por crear soluciones eficientes y escalables. Experto en diseño de API RESTful, manejo de bases de datos y optimización de sistemas. Con un enfoque en aprender y aplicar nuevas tecnologías para mejorar procesos y productos.',
    skills: [
      'Node.js',
      'Express.js',
      'MongoDB',
